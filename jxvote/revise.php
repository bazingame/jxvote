...
$DB->select('candidate','personal_info',"openId = '$openId'");
$data = $DB->fetchArray(MYSQL_ASSOC);
$personal_info = $data[0]['personal_info'];
$personal_info = json_decode($personal_info,true);
...
<div id="container" class="mui-panel mui--z3">
    <div id="inner1">
        ...
        <div class="mui-tabs__pane mui--is-active" id="pane-default-1">
            <form action="<?php echo './signData.php?type=revise'; ?>" method="POST">
                <div class="mui-textfield mui-textfield--float-label">
                    <input type="text" name="name"  value="<?php echo $personal_info['name'];?>" required>
                    <label>姓名</label>
                </div>
                <div class="mui-textfield mui-textfield--float-label">
                    <input type="text" name="sid" value="<?php echo $personal_info['sid']; ?>" required>
                    <label>学号</label>
                </div>
                <div class="mui-textfield mui-textfield--float-label">
                    <input type="text" name="department" value="<?php echo $personal_info['college']; ?>" required>
                    <label>院系</label>
                </div>
                <div class="mui-textfield mui-textfield--float-label">
                    <input type="text" name="QQ" value="<?php echo $personal_info['qq']; ?>" required>
                    <label>QQ</label>
                </div>
                <div class="mui-textfield mui-textfield--float-label">
                    <input type="text" name="tel" value="<?php echo $personal_info['phone']; ?>" required>
                    <label>电话</label>
                </div>
                <div class="mui-textfield mui-textfield--float-label">
                    <textarea name="album_subject"  required><?php echo $album_info['subject'];?></textarea>
                    <label>相册主题</label>
                </div>
                <br />
                <button id="confirm" class="mui-btn mui-btn--raised mui-btn--primary" type="submit" style="background-color:rgb(102,153,102);">确认修改</button>
            </form>
        </div>
...
<nav class="bottom-nav">
    ...
    <div class="btn-d ">
        ...
        <div class="bottomSign" style="margin:0px;width: 100%;height: 100%;" >修改信息</div>
    </div>
    <div class="btn-d ">
