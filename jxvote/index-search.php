...
<body>
    ...
    <div class="container mui-panel mui--z3" style="padding: 15px 10px 15px 10px;">
        ...
        <div class="vote-tip mui-table">* 投票规则：每个微信号每天能在个人，团队版块各投一票</div>
            <table>
                <tr>
                    <td>搜索结果<div class="number"><?php echo $num ?></div></td>
        ...
        <div class="register clearFix">
            ...
            <div class="new" onclick="javascript:location.href = './index-vote.php';">投票排行</div>
        </div>
...
echo $html;
                    ...
                    <div class="mui-panel" style="text-align: center;">
                      <h3 style="margin-top:0px;">他/她还没有报名呢~</h3>
                      <button class="mui-btn mui-btn--primary" onclick="javascript:location.href = './index-vote.php';">看看其他人</button>
                    </div>
HTML;
echo $html;
                }
