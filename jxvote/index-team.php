...
<body>
    ...
    <div class="container mui-panel mui--z3" style="padding: 15px 10px 15px 10px;">
        ...
        <div class="vote-tip mui-table">* 投票规则：每个微信号每天能在个人，团队版块各投一票</div>
            <table>
                <tr>
                    <td>报名队伍<div class="number"><?php echo $num ?></div></td>
        ...
        <div class="register clearFix">
            <div class="logo"></div>
            <div class="rank" onclick="javascript:location.href = './index.php';">查看所有</div>
            ...
            <div class="new" onclick="javascript:location.href = './index-team-vote.php';">投票排行</div>
        </div>
