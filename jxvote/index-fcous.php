...
<body>
    ...
    <div class="container mui-panel mui--z3" style="padding: 15px 10px 15px 10px;">
        ...
        <div class="vote-tip mui-table">* 投票规则：每个微信号每天能在个人，团队版块各投一票</div>
            <table>
                <tr>
                    <td>关注人数<div class="number"><?php echo $num ?></div></td>
        ...
        <div class="register clearFix">
            <div class="logo"></div>
            <div class="rank">————</div>
            <div class="attention" onclick="javascript:location.href = './index.php';">查看所有</div>
            <div class="new">————</div>
        </div>
            ...
            <div class="list-one" style="width: 100%;">
                ...
                if(count($data)){
                    ...
                    <div class="user-bottom">
                        ...
                        <div class="operation">
                            <div class="op-attention" fcous="$id">取消关注</div>
...
echo $html;
                    ...
                    <div class="mui-panel" style="text-align: center;">
                      <h3 style="margin-top:0px;">你还没有关注任何人呢~</h3>
                      <button class="mui-btn mui-btn--primary" onclick="javascript:location.href = './index.php';">查看所有</button>
                    </div>
HTML;
echo $html;
                }
