...
<div class="container"  style="padding: 15px 10px 15px 10px;position:relative;border-top:100px solid #fff;">
                        ...
                        <div class="onePhotoPartBox">
                            <div class="onePhotoPart">
                               <div class="divideLine"></div>
                                {$img}
                                <div class="itdPhotoWord">{$value['words']}</div></br>
...
<div class="giftList">
    <div class="giftWords">
        ...
        <div><span class="wordModeII">凡是报名、投票的可以凭截图到新体育馆康力健身俱乐部领取单次体验卡一张（或于军训结束在三翼摆点处领取）</span></div>
