...
$user->timePlus();
$isHeart = $user->checkHeart();

$view = new View();
$data = $view->filterHeart('A');
$num = count($data);
...
<body onload="if (<?php echo $isWx; ?>) {if (<?php echo $isHeart; ?>) {alert('谁的笑触动了你的心弦，心动他\\她吧，可以连击哦！！！活动结束后，连击数的高的人将获得意外的惊喜！')}} else{alert('谁的笑触动了你的心弦，心动他\\她吧，可以连击哦！！！活动结束后，连击数的高的人将获得意外的惊喜！')}">
        ...
        <div style="width: 100%;height: 30px;">
            <div style="width: 80%;height: 100%;margin:auto;">
                <div style="width:27%;margin-left: 5%; float: left;height: 100%;">
                    <div style="width: 100%;margin: auto;background-color: #39a1f4;font-size: 14px;height: 100%;color: white;padding: 5px 12px;border-radius: 4px;" onclick="location.href = './heart.php'">随机排序</div>
                </div>
                <div style="width: 27%;margin-left: 5%;float: left;height: 100%;">
                    <div style="width: 100%;margin: auto;background-color: #39a1f4;font-size: 14px;height: 100%;color: white;padding: 5px 12px;border-radius: 4px;">————</div>
                </div>
                <div style="width: 27%;margin-left: 5%;float: left;height: 100%;">
                    <div style="width: 100%;margin: auto;background-color: #39a1f4;font-size: 14px;height: 100%;color: white;padding: 5px 12px;border-radius: 4px;" onclick="location.href = './heart-vote.php'">心跳排行</div>
                </div>
            </div>
        </div>
...
echo $html;
    ...
    <script type="text/javascript">
        ...
        function removeC(){
            $('.d').removeClass('shake-false');
        }    
        $('.d-false').click(function() {
            $(this).addClass('shake');
            var id=$(this).attr("num");
            var geter = $(".get[id="+id+"]");
            var heartnum = parseInt(geter.html());
            $.ajax({
                url:"./heart-add-false.php?id="+id,
                type:"get",
                success:function(data){
                    heartnum += 0;
                    geter.html(heartnum);
